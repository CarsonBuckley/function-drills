...
//CODE HERE
let ninjaStr = "I am a Javascript ninja!"

const jsNinja = str => {
  return str
}

console.log(jsNinja(ninjaStr))
...
const compareNumsTernary = (num1, num2) => {
    return num1 > num2 ? num1
    : num1 < num2 ? num2
    : num1
}

console.log(compareNumsTernary(10, 9))
...
console.log(exclaimThree("hi my name is carson"))
...
let nameGreeting = nameCheck("Carson")
...
const bestMovie = str => (`${avengers} is the best movie ever!`)
...
console.log(emailCheck("carsonbuckley@gmail.com"))
...
//CODE HERE
function buyChocFrog(gold) {
  let chocFrog = gold / 3
    return chocFrog
}

console.log(buyChocFrog(300))
